...
- Definir des schemas de validation avec TypeScript pur
- Implementer une validation runtime avec contraintes
- Gerer le versioning de schemas avec migration
...
1. **Pieges JSON** — demonstrer les problemes de Date, BigInt, undefined et creer un serialiseur sur
2. **Definition de schema** — definir des schemas order/payment avec interfaces TypeScript + fonction de validation
3. **Validation runtime** — implementer une fonction validate qui verifie champs requis, types et contraintes
