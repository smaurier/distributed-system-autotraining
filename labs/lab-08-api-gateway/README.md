...
- Implementer le routage de requetes vers les services backend
- Agreger les reponses de plusieurs services en une seule reponse
...
Implementer une fonction qui appelle plusieurs services en parallele et combine leurs reponses en un seul objet.
...
Implementer un middleware qui ajoute un correlation ID unique a chaque requete pour le tracing distribue.
...
3. Verifier vos resultats avec la solution : `npx tsx labs/lab-08-api-gateway/solution.ts`
...
- **Request Aggregation** : composition de plusieurs appels backend en une reponse
- **JWT Propagation** : transmission du token d'authentification aux services
- **Token Bucket** : algorithme de rate limiting base sur des jetons consommes par requete
