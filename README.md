...
|---|-----|-------|-------|--------|
| 01 | `lab-01-appel-externe-resilient` | Zéro | circuit breaker, retry, backoff, test de panne | · à écrire |
| 02 | `lab-02-saga-outbox-sur-un-flux` | Intervention | existant | · à écrire |
